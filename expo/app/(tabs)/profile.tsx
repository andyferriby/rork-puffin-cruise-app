...
const styles = StyleSheet.create({ root:{flex:1,backgroundColor:theme.bg}, header:{paddingHorizontal:20,paddingBottom:14}, title:{fontSize:34,fontWeight:"900",color:theme.text}, subtitle:{marginTop:4,color:theme.textMuted,fontSize:14}, lookup:{margin:16,padding:16,borderRadius:20,backgroundColor:theme.white,borderWidth:1,borderColor:theme.border,gap:10}, lookupTitle:{fontSize:17,fontWeight:"900",color:theme.text}, input:{height:48,borderRadius:14,backgroundColor:theme.bg,paddingHorizontal:14,color:theme.text}, lookupBtn:{height:48,borderRadius:14,backgroundColor:theme.sea,alignItems:"center",justifyContent:"center"}, lookupBtnText:{color:theme.white,fontWeight:"900"}, loyalty:{marginHorizontal:16,padding:20,borderRadius:22}, loyaltyHead:{flexDirection:"row",alignItems:"center",gap:12}, tierEmoji:{fontSize:42}, tierTitle:{color:theme.white,fontSize:20,fontWeight:"900"}, tierMeta:{marginTop:3,color:"rgba(255,255,255,0.8)",fontWeight:"700"}, progressTrack:{height:8,borderRadius:4,backgroundColor:"rgba(255,255,255,0.25)",marginTop:18,overflow:"hidden"}, progressFill:{height:8,borderRadius:4,backgroundColor:theme.white}, nextText:{marginTop:9,color:"rgba(255,255,255,0.82)",fontWeight:"800",fontSize:12}, card:{margin:16,marginBottom:0,padding:18,borderRadius:20,backgroundColor:theme.white,borderWidth:1,borderColor:theme.border}, cardHead:{flexDirection:"row",alignItems:"center",gap:8,marginBottom:10}, cardTitle:{fontSize:18,fontWeight:"900",color:theme.text}, benefit:{flexDirection:"row",alignItems:"center",gap:10,paddingVertical:8}, check:{color:theme.sea,fontWeight:"900",fontSize:17}, benefitText:{color:theme.text,fontSize:15}, actions:{padding:16,gap:12}, action:{padding:18,borderRadius:20,backgroundColor:theme.foam,borderWidth:1,borderColor:theme.border}, actionTitle:{marginTop:10,fontSize:17,fontWeight:"900",color:theme.text}, actionSub:{marginTop:4,color:theme.textMuted,fontSize:13}, empty:{color:theme.textMuted,lineHeight:20}, trip:{flexDirection:"row",alignItems:"center",gap:10,paddingVertical:10,borderTopWidth:1,borderTopColor:theme.border}, tripTitle:{fontWeight:"800",color:theme.text}, tripDate:{marginTop:2,color:theme.textMuted,fontSize:12} });
