      ...
      <ScrollView contentContainerStyle={{ paddingBottom: 36 }} keyboardShouldPersistTaps="handled">
        ...
        <View style={styles.priceCard}>
          ...
          <View style={styles.legalRow}>
            <Pressable onPress={() => Linking.openURL("https://puffincruisesamble.co.uk/privacy-policy/")}>
              <Text style={styles.legalLink}>Privacy Policy</Text>
            </Pressable>
            <Text style={styles.legalSep}>·</Text>
            <Pressable onPress={() => Linking.openURL("https://puffincruisesamble.co.uk/terms-conditions/")}>
