...
- [x] **Interactive Map** — Amble Harbour, Coquet Island route, parking, landmarks with category filters
...
- [x] Map — harbour map with route, parking, landmarks, category filters
...
- [x] Admin — PIN-locked schedule/price editor, push notifications, QR scanner
